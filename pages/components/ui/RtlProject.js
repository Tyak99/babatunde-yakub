    ...
    <div className="flex flex-col lg:flex-row">
      <div className="p-4  lg:py-12 lg:px-12 lg:w-3/6 flex space-y-4 flex-col items-start">
        ...
        <div className='flex flex-row space-x-5'>
          {webLink && <a href={webLink} target='_blank' className='font-semibold hover:text-gray-500'>View Website</a>}
          {mobileLink && <a href={mobileLink} target='_blank' className='font-semibold hover:text-gray-500'>View App</a>}
        </div>
      </div>
